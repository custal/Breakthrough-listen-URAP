...
print(time.time()-start)
# marked_indices = add_freq_range(fil, marked_indices, 2307, 2364) # This line demonstartes the ability to manually remove a specific range of frequencies. In this case we are removing the missing data which the mark_RFI does not detect.
start = time.time()
