...
Results (seconds):
Time for np.ma.mean: 7.63
Time for np.mean: 2.58
...
def plot_time_series_nanmean(filename, f_start=None, f_stop=None, if_id=0, logged=True, orientation='h', MJD_time=False, **kwargs):
    ...
    if len(plot_data.shape) > 1:
        plot_data = np.ma.mean(plot_data, axis=1)
    else:
...
plot_time_series_nanmean("spliced_blc0001020304050607_guppi_57936_37003_HIP116719_0057.gpuspec.0002.h5")
plot_time_series_mean("spliced_blc0001020304050607_guppi_57936_37003_HIP116719_0057.gpuspec.0002.h5")
